...
# Heading 1 {docsify-ignore} (`# Heading 1`)
...
## Heading 2 {docsify-ignore} (`## Heading 2`)
...
**note:** _If you want to use the 3x backtick inside a code block then you can use 4x` in the outer block_
